...
- 2026-08-22 d7: inference engine (prefill/decode/generate on KV-cache), int8 4MB variant, bench_engine (fp32 123 tok/s, first-token 10ms; int8 5x smaller but slower decode; compile needs MSVC). Tag v0.2.1.- 2026-08-22 d8: LoRA SFT - hand-rolled LoRALinear (r8/a16, 3.3% trainable), dolly-15k formatting, merge+convert, local evidence run, ADR-08. Tag v0.3.0.
